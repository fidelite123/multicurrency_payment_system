...
public LoginForm() {
	...
	login.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			userinterface ad = new userinterface();
	...
	contentPane.add(passwordField);
     ...
     forgotPasswordButton.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
             ...
             String email = JOptionPane.showInputDialog(LoginForm.this, "Enter your email:");
             if (email != null && !email.isEmpty()) {
                 ...
                 JOptionPane.showMessageDialog(LoginForm.this, "A password reset link has been sent to your email.");
             } else {
                 JOptionPane.showMessageDialog(LoginForm.this, "Please enter a valid email.");
             }
         }
     });
